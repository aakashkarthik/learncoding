...
int main(void)
{
	...
	return 0;//the result may be a mistake as sometimes the total can be a ten multiple meaning the check digit will be 10 which is two digits.(same in chap4 ex7)
}
